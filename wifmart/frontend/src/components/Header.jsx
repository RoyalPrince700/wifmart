// filepath: /c:/Users/HP/Desktop/com/wifmart/frontend/src/components/Header.jsx
        ...
        <div className="lg:flex hidden items-center gap-7">
          ...
          {!user?._id && (
            <div className="lg:flex hidden items-center gap-5">
              <Link to="/login" className="px-2 py-1 rounded-md text-white hover:bg-red-700 bg-red-600 p-3">
                Login
              </Link>
            </div>
          )}
